...
PRESETS = {
    ...
    "gp_bc_rup": {
        "rup_group_admission": "off",
        "rup_accuracy_priority": "off",
        "rup_accuracy_q_boost_ratio": "0.0",
        "rup_risk_gated_floor": "off",
        "rup_q_smoothness": "off",
        "rup_budget_lower_ratio": "0.99",
        "rup_budget_upper_ratio": "1.02",
        "rup_budget_max_adjust_ratio": "0.10",
        "rup_cumulative_budget_guard": "on",
        "rup_max_work_debt_ratio": "0.01",
        "rup_debt_repay_utility_threshold": "1.0",
    },
